...
const TitleCardsGenero = ({ generoId }) => {
  ...
  useEffect(() => {
    fetch(`https://api.themoviedb.org/3/discover/movie?with_genres=${generoId}&language=en-US&page=1`, options)
      .then(res => res.json())
...
export default TitleCardsGenero;